...
The project models a complex Operating System process scheduler using custom-built hierarchical data structures (Deque, Queue, and Stack) without relying on the Standard Template Library (STL). It includes comprehensive behavioral verification using the modern `µnit` testing framework.
...
### 4. Dynamic Execution & Failure Pipelines
